...
def install_streamlink():
    """Install Streamlink with error handling"""
    try:
...
def download_twitch_vod():
    """Main download function with directory handling"""
    setup_directories()
    install_streamlink()
    ...
    command = [
        ...
        "--hls-live-restart",
        "--retry-streams", "5",
        "-o", str(output_path)  # Directly save as the user-provided filename
    ]
    ...
    try:
        ...
        # Create the processed copy and delete the original
